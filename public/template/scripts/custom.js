...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function init_template() {
        ...
        if (inputField.length) {
            ...
            var regularTextarea = document.querySelectorAll(
            ...
            if (validateField.length) {
                validateField.forEach((el) =>
                    el.addEventListener("keyup", (e) => {
                        ...
                        switch (getAttribute) {
                            case "name":
                                nameValidator.test(el.value)
                                    ? valid(el)
                                    : invalid(el);
                                break;
                            case "number":
                                numberValidator.test(el.value)
                                    ? valid(el)
                                    : invalid(el);
                                break;
                            case "email":
                                mailValidator.test(el.value)
                                    ? valid(el)
                                    : invalid(el);
                                break;
                            case "text":
                                textValidator.test(el.value)
                                    ? valid(el)
                                    : invalid(el);
                                break;
                            case "url":
                                linkValidator.test(el.value)
                                    ? valid(el)
                                    : invalid(el);
                                break;
                            case "tel":
                                phoneValidator.test(el.value)
                                    ? valid(el)
                                    : invalid(el);
                                break;
                            case "password":
                                passwordValidator.test(el.value)
                                    ? valid(el)
                                    : invalid(el);
                                break;
                        }
        ...
        checkedCard.forEach((el) =>
            el.addEventListener("click", (e) => {
                if (
                    el.querySelector("input").getAttribute("checked") ==
                    "checked"
                ) {
            ...
            if (menus.length) {
                ...
                menuSidebar.forEach(function (e) {
                    if (e.getAttribute("data-menu-width") === "cover") {
                        ...
                        e.style.width =
                            e.getAttribute("data-menu-width") + "px";
                    }
                });
                ...
                menuSheets.forEach(function (e) {
                    if (e.getAttribute("data-menu-width") === "cover") {
                        ...
                        e.style.width =
                            e.getAttribute("data-menu-width") + "px";
                        e.style.height =
                            e.getAttribute("data-menu-height") + "px";
                    }
                });
                ...
                menuOpen.forEach((el) =>
                    el.addEventListener("click", (e) => {
                        ...
                        var menuRight =
                            menu.classList.contains("menu-box-right");
                        var menuTop = menu.classList.contains("menu-box-top");
                        var menuBottom =
                            menu.classList.contains("menu-box-bottom");
                ...
                //Closing Menus
                const menuClose = document.querySelectorAll(
                    ".close-menu, .menu-hider"
                );
        ...
        function activateMenus() {
            const menuActive =
                document.querySelectorAll("[data-menu-active]")[0];
            if (menuActive) {
        ...
        function card_extender() {
            ...
            for (let i = 0; i < cards.length; i++) {
                ...
                if (
                    cards[i].getAttribute("data-card-height") === "cover-card"
                ) {
                    var windowHeight = window.outerHeight;
                ...
                if (
                    cards[i].getAttribute("data-card-height") === "cover-full"
                ) {
                    if (
                        window.matchMedia("(display-mode: fullscreen)").matches
                    ) {
        ...
        function selectHighlight() {
            var rememberHighlight = localStorage.getItem(
                pwaName + "-Highlight"
            );
        ...
        var gradientData = document.querySelectorAll(
        ...
        function checkDarkMode() {
            ...
            const darkModeDetect =
                document.querySelectorAll(".detect-dark-mode");
        ...
        if (accordionBtn.length) {
            accordionBtn.forEach((el) =>
                el.addEventListener("click", (event) => {
                    el.querySelector("i:last-child").classList.toggle(
                        "fa-rotate-180"
                    );
                })
            );
        ...
        if (inputArray.length) {
            ...
            function prepareUpload(event) {
                ...
                document.getElementsByClassName(
                    "upload-file-name"
                )[0].innerHTML = files[0].name;
                document.getElementsByClassName(
                    "upload-file-modified"
                )[0].innerHTML = files[0].lastModifiedDate;
                document.getElementsByClassName(
                    "upload-file-size"
                )[0].innerHTML = files[0].size / 1000 + "kb";
                document.getElementsByClassName(
                    "upload-file-type"
                )[0].innerHTML = files[0].type;
            }
        }
        ...
        if (locationBut.length) {
            ...
            if (
                typeof locationSupport != "undefined" &&
            ...
            var getLocation =
                document.getElementsByClassName("get-location")[0];
        ...
        if (cardScale.length) {
            cardScale.forEach((el) =>
                el.addEventListener("mouseenter", (event) => {
                    el.querySelectorAll("img")[0].classList.add(
                        "card-scale-image"
                    );
                })
            );
        ...
        if (checkVisited.length) {
            function check_visited_links() {
                var visited_links =
                    JSON.parse(
                        localStorage.getItem(pwaName + "_Visited_Links")
                    ) || [];
        ...
        if (adblockMessage) {
            ...
            if (adElementStyle.display === "none") {
                document
                    .getElementById("adblock-message")
                    .classList.remove("disabled");
            }
        }
        ...
        if (fixedAds || scrollAds) {
            //Activate scroll Ad
            var activateScrollAd =
                document.getElementById("activate-scroll-ad");
        ...
        if (scrollItems.length) {
            ...
            window.addEventListener("scroll", function () {
                if (
                    document.querySelectorAll(".scroll-ad, .header-auto-show")
                        .length
                ) {
                    ...
                    let inside_footer =
                        window_height - total_scroll_height + 1000 <= 150;
                    if (scrollAd.length) {
        ...
        if (classicToggle.length) {
            classicToggle.forEach((el) =>
                el.addEventListener("click", (event) => {
                    ...
                    el.querySelector("i:last-child").style.transition =
                        "all 250ms ease";
                })
            );
        }
        ...
        if (toastTrigger.length) {
            toastTrigger.forEach((el) =>
                el.addEventListener("click", (event) => {
                    ...
                    var notificationToast = new bootstrap.Toast(
                        notificationToast
                    );
        ...
        */
        ...
        if (vibrateButton.length) {
            ...
            var stopVibrating =
                document.getElementsByClassName("stop-vibrating")[0];
                ...
                el.addEventListener("click", (e) => {
                    ...
                    var timerAdFunction = setInterval(function () {
                        if (timedAdTimer <= 1) {
                            ...
                            document
                                .getElementById(timedAdData)
                                .querySelectorAll("span")[0].style.display =
                                "none";
                        } else {
            ...
            var timerAdFunction = setInterval(function () {
                if (autoAdTime <= 1) {
                    ...
                    document
                        ...
                        .classList.add("menu-active");
                    var autoAdCloseTime =
                        autoAd[0].getAttribute("data-timed-ad");
        ...
        if (visitDetection) {
            ...
            var lastVisitValue = localStorage.getItem(
        ...
        //Reading Time
        var readingTextDiv = document.querySelectorAll(
        ...
        if (readingTextDiv.length) {
            ...
            )[0].innerHTML = readingWords;
            document.getElementsByClassName(
                "reading-progress-time"
            )[0].innerHTML = readingMinutes + ":" + readingSeconds;
        }

        //Text Resizer
        var textSizeChanger = document.querySelectorAll(".text-size-changer");
        if (textSizeChanger.length) {
            var textSizeIncrease = document.querySelectorAll(
                ".text-size-increase"
            );
            var textSizeDecrease = document.querySelectorAll(
                ".text-size-decrease"
            );
            var textSizeDefault =
                document.querySelectorAll(".text-size-default");
        ...
        if (qr_image.length) {
            ...
            var qr_auto =
                document.getElementsByClassName("generate-qr-auto")[0];
            var qr_api_address =
            ...
            var qr_btn =
                document.getElementsByClassName("generate-qr-button")[0];
            if (qr_btn) {
                qr_btn.addEventListener("click", function () {
                    var get_qr_url =
                        document.getElementsByClassName("qr-url")[0].value;
                    var qr_api_address =
                        "https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=";
                    var qr_img =
        ...
        if (searchField.length) {
            ...
            var searchNoResults =
                document.querySelectorAll(".search-no-results");
            var searchTotal = document.querySelectorAll(
                ".search-results div"
            )[0].childElementCount;
            ...
            function searchFunction() {
                ...
                if (searchVal != "") {
                    ...
                    for (let i = 0; i < searchFilterItem.length; i++) {
                        var searchData =
                            searchFilterItem[i].getAttribute(
                                "data-filter-name"
                            );
            ...
            if (shareCheck.length) {
                ...
                document
                    ...
                    .forEach((x) =>
                        x.setAttribute(
                            "href",
                            "whatsapp://send?text=" + share_link
                        )
                    );
                document
                    .querySelectorAll(".shareToMail")
                    .forEach((x) =>
                        x.setAttribute("href", "mailto:?body=" + share_link)
                    );
                document
        ...
        if (tabTrigger.length) {
            tabTrigger.forEach(function (e) {
                if (e.hasAttribute("data-active")) {
                    var highlightColor =
                        e.parentNode.getAttribute("data-highlight");
            ...
            tabTrigger.forEach((el) =>
                el.addEventListener("click", (e) => {
                    var highlightColor =
                        el.parentNode.getAttribute("data-highlight");
        ...
        if (autoActivate.length) {
            var autoActivateData =
                autoActivate[0].getAttribute("data-auto-activate");
        ...
        var offlineMessage =
            document.getElementsByClassName("offline-message")[0];
        var onlineMessage =
            document.getElementsByClassName("online-message")[0];
        ...
        //Android Badge
        const AndroidBadge = document.querySelectorAll(
            ...
            if (!checkPWA.classList.contains("isPWA")) {
                ...
                if (pwaWindows.length) {
                    if (isMobile.Android()) {
                        ...
                        const pwaInstall =
                            document.querySelectorAll(".pwa-install");
        ...
        for (let i = 0; i < plugins.length; i++) {
            ...
            if (document.querySelectorAll("." + plugins[i].id + "-c").length) {
                document
                    .querySelectorAll("." + plugins[i].id + "-c")[0]
                    .remove();
            }
            ...
            if (plugTrigger.length) {
                ...
                if (
                    !document.querySelectorAll("." + plugins[i].id + "-p")
                        .length
                ) {
                    loadScript.parentNode.insertBefore(
                        loadScriptJS,
                        loadScript
                    );
                } else {
                ...
                if (plugins[i].style !== undefined) {
                    ...
                    if (
                        !document.querySelectorAll("." + plugins[i].id + "-s")
                            .length
                    ) {
