<div id="menu-main" class="menu menu-box-left rounded-0" data-menu-width="300" data-menu-active="nav-welcome">
    <div class="card rounded-0" data-card-height="150"
        style="background-image: url({{ asset(setting('bg_menu_kiri')) }});">
    ...
    <h6 class="menu-divider font-10 mt-4">Made with <i class="fa fa-heart color-red-dark pl-1 pr-1"></i> by
        @setting('name') in
